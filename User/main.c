...
{	
  ...
  TIMx_Configuration02(100,0,0,0);				//PH10-PH12，PI0口的PWM波输出占空比
  ...
  {       
    ...
    printf("recieved command：%s\n",cmd);
		...
		TIMx_Configuration01(100-ZKB_A0,100-ZKB_A1,100-ZKB_A2,100-ZKB_A3);				//PA0-PA3口的PWM波输出占空比
		
		ZKB_I0=(cmd[14]-'0')*10+(cmd[15]-'0');
		ZKB_H10=(cmd[8]-'0')*10+(cmd[9]-'0');
		ZKB_H11=(cmd[10]-'0')*10+(cmd[11]-'0');
		ZKB_H12=(cmd[12]-'0')*10+(cmd[13]-'0');
